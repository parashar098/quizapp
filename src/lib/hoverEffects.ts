...
export const hoverEffects = {
  ...
  card: {
    ...
    // Glow effect
    glow: 'hover:shadow-[0_0_20px_rgba(79,70,229,0.4)] transition-all duration-300',
    // Combined premium effect
    premium: 'hover:scale-105 hover:shadow-[0_20px_40px_rgba(79,70,229,0.2)] hover:-translate-y-3 transition-all duration-300 ease-out',
  },
  ...
  button: {
    ...
    // Gradient shift
    gradient: 'hover:via-purple-600 transition-all duration-300',
    // Combined premium
    premium: 'hover:scale-105 hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(79,70,229,0.3)] transition-all duration-300 ease-out',
  },
  ...
  logo: {
    ...
    glow: 'group-hover:drop-shadow-[0_0_8px_rgba(79,70,229,0.6)] transition-all duration-300',
  },
  ...
  input: {
    // Border glow
    glow: 'hover:border-brand-500 hover:shadow-[0_0_10px_rgba(79,70,229,0.3)] transition-all duration-300',
    // Focus state
...
export const motionHoverVariants = {
  card: {
    initial: { scale: 1, y: 0 },
    hover: { scale: 1.05, y: -8, boxShadow: '0 20px 40px rgba(79,70,229,0.2)' },
  },
  button: {
    initial: { scale: 1, y: 0 },
